        ...
        {/* <Select onValueChange={(value) => handleSelect(value)}>
          ...
          <SelectContent>
            {ScreenerOptions.map((option) => (
              <div key={option.value} className=" z-100 text-white" style={{backgroundImage: "linear-gradient(90deg, rgba(54, 15, 63, 0.5) 0%, rgba(10, 24, 49, 0.5) 97.15%)", zIndex:"10000",backgroundColor:"black"}}>
          ...
          >
            ...
            <SelectContent side="top">
              {[15, 20, 30, 40, 50].map((pageSize) => (
                <div key={pageSize} style={{backgroundImage: "linear-gradient(90deg, rgba(54, 15, 63, 0.5) 0%, rgba(10, 24, 49, 0.5) 97.15%)", zIndex:"10000",backgroundColor:"black", color:"white"}}>
